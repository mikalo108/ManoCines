...
export default function Index(props) {
   ...
   // State to hold current filters
       ...
       const handlePageChange = (page) => {
           router.get(route('order-products.index'), { page, ...filters }, { preserveState: true, replace: true });
       };
       ...
       const handleFilter = (newFilters) => {
           ...
           router.get(route('order-products.index'), { page: 1, ...newFilters }, { preserveState: true, replace: true });
       };
    ...
    if (props.auth.user.role !== 'Admin') {
        ...
        return (
            <AdminLayout
                ...
                lang={props.lang}
            >
            <Head title="Index - Order Products" />
                ...
                <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <main className="mt-6">
                        ...
                        <TableIndex 
                            ...
                            items={props.orderProducts.data} 
                            keyTable={keyOrderProducts} 
                            pagination={props.orderProducts} 
