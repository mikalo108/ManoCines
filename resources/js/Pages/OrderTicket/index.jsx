...
export default function Index(props) {
    const keyOrderTickets = "order-tickets";
    ...
    // State to hold current filters
        ...
        const handlePageChange = (page) => {
            router.get(route('order-tickets.index'), { page, ...filters }, { preserveState: true, replace: true });
        };
        ...
        const handleFilter = (newFilters) => {
            ...
            router.get(route('order-tickets.index'), { page: 1, ...newFilters }, { preserveState: true, replace: true });
        };
    ...
    if (props.auth.user.role !== 'admin') {
        ...
        return (
            <AdminLayout
                ...
                lang={props.lang}
            >
            <Head title="Index - Order Tickets" />
                ...
                <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <main className="mt-6">
                        ...
                        <TableIndex 
                            ...
                            items={props.orderTickets.data} 
                            keyTable={keyOrderTickets} 
                            pagination={props.orderTickets} 
