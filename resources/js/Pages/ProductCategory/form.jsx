...
export default function Form(props) {
    const keyElements = 'product-categories';
    const keyElement = 'product-category';
    const nameTableES = 'Categorías de productos';
    const nameElementES = 'categoría de producto';
