...
export default function Index(props) {
    ...
    // State to hold current filters
        ...
        const handlePageChange = (page) => {
            router.get(route('product-cinema.index'), { page, ...filters }, { preserveState: true, replace: true });
        };
        ...
        const handleFilter = (newFilters) => {
            ...
            router.get(route('product-cinema.index'), { page: 1, ...newFilters }, { preserveState: true, replace: true });
        };
