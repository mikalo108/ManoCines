...
export default function Index(props) {
    ...
    // State to hold current filters
        ...
        const handlePageChange = (page) => {
            router.get(route('rooms.index'), { page, ...filters }, { preserveState: true, replace: true });
        };
        ...
        const handleFilter = (newFilters) => {
            ...
            router.get(route('rooms.index'), { page: 1, ...newFilters }, { preserveState: true, replace: true });
        };
                ...
                <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <main className="mt-6">
                        ...
                        <TableIndex 
                            ...
                            items={props.rooms.data} 
                            keyTable={keyRooms} 
                            pagination={props.rooms} 
