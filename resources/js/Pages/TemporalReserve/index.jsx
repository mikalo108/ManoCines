...
export default function Index(props) {
    const keyTemporalReserves = "temporal-reserves";
    ...
    // State to hold current filters
        ...
        const handlePageChange = (page) => {
            router.get(route('temporal-reserves.index'), { page, ...filters }, { preserveState: true, replace: true });
        };
    ...
    if (props.auth.user.role !== 'admin') {
        ...
        return (
            <AdminLayout
                ...
                lang={props.lang}
            >
            <Head title="Index - Temporal Reserves" />
                ...
                <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <main className="mt-6">
                        ...
                        <TableIndex 
                            ...
                            items={props.temporalReserves.data} 
                            keyTable={keyTemporalReserves} 
                            pagination={props.temporalReserves} 
